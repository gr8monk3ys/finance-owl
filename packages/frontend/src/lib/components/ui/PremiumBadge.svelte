...
<span
  class="inline-flex items-center gap-1 rounded-full border font-semibold uppercase tracking-wider {colors[
    plan
  ]} {sizes[size]} {className}"
>
  <svg aria-hidden="true" class="h-2.5 w-2.5" fill="currentColor" viewBox="0 0 20 20">
    <path
      fill-rule="evenodd"
