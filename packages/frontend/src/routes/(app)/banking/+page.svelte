              ...
              <div class="account-card">
                <div class="account-header">
                  <div
                    ...
                    class:checking={account.type === 'checking'}
                  >
              ...
              <div class="interest-account-row">
                <div>
                  <span class="account-type-label"
                    >{acct.accountType === 'savings' ? 'Savings' : 'Checking'}</span
                  >
          ...
          {#each interest.payments as payment}
            <div class="payment-row">
              ...
              <span class="payment-date"
                >{payment.paidAt ? fmtDate(payment.paidAt) : 'Pending'}</span
              >
            </div>
          {/each}
        </div>
        ...
        <select id="transferFrom" name="fromAccountId" required>
          ...
          {#each accounts.filter((a: any) => a.status === 'active') as acct}
            <option value={acct.id}>
              {acct.type === 'savings' ? 'Savings' : 'Checking'} (****{acct.accountNumberMask}) - {fmt(
                acct.balance,
              )}
            </option>
          {/each}
