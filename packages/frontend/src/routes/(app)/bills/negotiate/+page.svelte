		...
		<Card class="border border-red-500/30">
			...
			<div class="space-y-2">
				{#each expiring as neg}
					<div
						class="flex items-center justify-between rounded-lg bg-surface-900/50 px-4 py-3"
					>
						<div>
						...
						<div class="flex items-center gap-3">
							...
							>
								...
								/>
								<input type="hidden" name="targetAmount" value={neg.negotiatedAmount ?? neg.currentAmount} />
					...
					<div class="rounded-lg border border-surface-700 bg-surface-900/50 p-4">
						<div class="mb-3 flex items-start justify-between">
							<div class="flex items-center gap-2">
								<div
									class="flex h-8 w-8 items-center justify-center rounded-lg bg-surface-700"
								>
									<svg
		...
		{:else}
			<div class="py-6 text-center">
				...
				<p class="mt-3 text-surface-300">
					Click "Analyze My Bills" to scan your recurring transactions for negotiation
					opportunities
				</p>
			</div>
		{/if}
									...
									<div class="flex items-center justify-end gap-2">
										...
										>
											...
											<input
												type="hidden"
												name="currentAmount"
												value={neg.currentAmount}
											/>
											<input
												type="hidden"
												name="targetAmount"
												value={neg.targetAmount}
											/>
		...
		>
			...
			<div>
				...
				<textarea
					...
					rows="2"
					class="w-full rounded-lg border border-surface-700 bg-surface-800 px-3 py-2 text-white placeholder-surface-500 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500"
					placeholder="Agent name, reference number, details..."
				></textarea>
			</div>
				...
				<div>
					...
					<div class="space-y-2">
						{#each currentScript.competitorPricing as comp}
							<div
								class="flex items-center justify-between rounded-lg bg-surface-900/50 px-3 py-2"
							>
								<div>
					...
					<div class="space-y-2">
						{#each currentScript.tips as tip, i}
							<div class="flex gap-2 rounded-lg bg-surface-900/50 p-3">
								<span class="mt-0.5 flex-shrink-0 text-xs font-bold text-primary-400"
									>{i + 1}.</span
								>
