  ...
  <div class="grid gap-6 lg:grid-cols-5">
    ...
    <div class="lg:col-span-2 space-y-4">
      <Card>
        ...
        <div class="space-y-4">
          <div>
            <label for="principal" class="block text-sm font-medium text-surface-300"
              >Loan Amount</label
            >
            <input
              id="principal"
          ...
          <div class="space-y-2">
            <div class="flex items-center justify-between">
              ...
              <span class="text-sm font-semibold text-green-400"
                >{fmt(scheduleResult.interestSaved)}</span
              >
            </div>
            <div class="flex items-center justify-between">
              <span class="text-sm text-surface-300">Months Saved</span>
              <span class="text-sm font-semibold text-green-400"
                >{scheduleResult.monthsSaved} months</span
              >
            </div>
            <div class="flex items-center justify-between">
        ...
        <Card>
          ...
          {#if extraPayment > 0}
            <p class="mt-1 text-xs text-surface-500">
              + {fmt(extraPayment)} extra = {fmt(monthlyPayment + extraPayment)}
            </p>
          {/if}
        </Card>
        <Card>
          ...
          <p class="mt-1 text-2xl font-bold text-red-400">
            {fmt(scheduleResult.totalInterestPaid)}
          </p>
        </Card>
        <Card>
        ...
        <div class="overflow-hidden rounded-lg bg-surface-900 p-4">
          ...
          {#if extraPayment > 0}
            <div class="mt-2 flex items-center gap-4 text-xs text-surface-400">
              ...
              <span class="flex items-center gap-1">
                <span class="inline-block h-0.5 w-4 border-t border-dashed border-red-500/40"
                ></span>
                Without extra payments
              </span>
            </div>
