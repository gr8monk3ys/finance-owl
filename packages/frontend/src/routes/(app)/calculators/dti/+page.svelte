  ...
  <div class="grid gap-6 lg:grid-cols-5">
    ...
    <div class="lg:col-span-2 space-y-4">
      <Card>
        ...
        <div>
          <label for="income" class="block text-sm font-medium text-surface-300"
      ...
      <Card>
        ...
        <div class="space-y-4">
          <div>
            <label for="mortgage" class="block text-sm font-medium text-surface-300"
              >Mortgage / Rent</label
            >
            <input
              id="mortgage"
          ...
          <div>
            <label for="student" class="block text-sm font-medium text-surface-300"
              >Student Loans</label
            >
            <input
              id="student"
          ...
          <div>
            <label for="credit" class="block text-sm font-medium text-surface-300"
    ...
    <div class="lg:col-span-3 space-y-4">
      ...
      <Card>
        <div class="flex items-start gap-3">
          <div
            class="mt-0.5 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full {ratingColor.text}"
      ...
      <div class="grid gap-4 sm:grid-cols-3">
        ...
        <Card>
          ...
          <p
            class="mt-1 text-xl font-bold {remainingCapacity > 0
              ? 'text-green-400'
              : 'text-red-400'}"
          >
      ...
      <Card>
        ...
        <div class="space-y-2 text-sm">
          <div
            class="flex items-center gap-3 rounded-lg bg-surface-900 px-3 py-2 {rating ===
            'excellent'
          ...
          <div
            class="flex items-center gap-3 rounded-lg bg-surface-900 px-3 py-2 {rating === 'good'
          ...
          <div
            class="flex items-center gap-3 rounded-lg bg-surface-900 px-3 py-2 {rating === 'fair'
          ...
          <div
            class="flex items-center gap-3 rounded-lg bg-surface-900 px-3 py-2 {rating === 'poor'
