  ...
  <div class="grid gap-6 lg:grid-cols-5">
    ...
    <div class="lg:col-span-2 space-y-4">
      <Card>
        ...
        <div class="space-y-4">
          <div>
            <label for="homePrice" class="block text-sm font-medium text-surface-300"
              >Home Price</label
            >
            <input
              id="homePrice"
          ...
          <div>
            <label for="downPayment" class="block text-sm font-medium text-surface-300"
              >Down Payment</label
            >
          ...
          <div>
            <label for="interestRate" class="block text-sm font-medium text-surface-300"
              >Interest Rate (%)</label
            >
            <input
              id="interestRate"
          ...
          <div>
            <label for="loanTerm" class="block text-sm font-medium text-surface-300"
              >Loan Term</label
            >
            <div class="mt-1 flex gap-2">
              {#each [15, 20, 30] as term}
                <button
                  class="flex-1 rounded-lg border px-3 py-2 text-sm font-medium transition {loanTermYears ===
                  term
          ...
          <div>
            <label for="propertyTax" class="block text-sm font-medium text-surface-300"
          ...
          <div>
            <label for="homeInsurance" class="block text-sm font-medium text-surface-300"
        ...
        {#if showSchedule}
          <div class="mt-4 max-h-96 overflow-auto">
            ...
            <p class="mt-2 text-xs text-surface-500">
              Showing yearly snapshots (month 1 of each year). Full schedule contains {totalPayments}
              entries.
            </p>
          </div>
        {/if}
