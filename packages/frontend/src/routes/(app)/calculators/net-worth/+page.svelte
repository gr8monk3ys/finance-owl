<script lang="ts">
  ...
  let totalAssets = $derived(
    cashAndSavings + investments + propertyValue + vehicleValue + otherAssets,
  );
  let totalLiabilities = $derived(
    mortgageBalance + autoLoans + studentLoans + creditCardDebt + otherLiabilities,
  );
  ...
  // Donut chart
  function getDonutSegments(data: Array<{ label: string; value: number; color: string }>): Array<{
    offset: number;
    length: number;
    color: string;
    label: string;
  ...
  <div class="grid gap-6 lg:grid-cols-2">
    ...
    <div class="space-y-4">
      <Card>
        ...
        <div class="space-y-4">
          <div>
            <label for="cash" class="block text-sm font-medium text-surface-300"
              >Cash & Savings</label
            >
            <input
              id="cash"
          ...
          <div>
            <label for="invest" class="block text-sm font-medium text-surface-300"
          ...
          <div>
            <label for="property" class="block text-sm font-medium text-surface-300"
          ...
          <div>
            <label for="vehicles" class="block text-sm font-medium text-surface-300"
              >Vehicle Value</label
            >
            <input
              id="vehicles"
          ...
          <div>
            <label for="otherA" class="block text-sm font-medium text-surface-300"
              >Other Assets</label
            >
            <input
              id="otherA"
              ...
              {#each assetSegments as seg}
                <div class="flex items-center justify-between text-sm">
                  <div class="flex items-center gap-2">
                    <span class="h-2.5 w-2.5 rounded-full" style="background-color: {seg.color}"
                    ></span>
    ...
    <div class="space-y-4">
      <Card>
        ...
        <div class="space-y-4">
          <div>
            <label for="mortBal" class="block text-sm font-medium text-surface-300"
          ...
          <div>
            <label for="autoLoan" class="block text-sm font-medium text-surface-300"
              >Auto Loans</label
            >
            <input
              id="autoLoan"
          ...
          <div>
            <label for="stuLoan" class="block text-sm font-medium text-surface-300"
              >Student Loans</label
            >
            <input
              id="stuLoan"
          ...
          <div>
            <label for="ccDebt" class="block text-sm font-medium text-surface-300"
          ...
          <div>
            <label for="otherL" class="block text-sm font-medium text-surface-300"
