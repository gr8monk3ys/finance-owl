	...
	<div class="grid gap-6 lg:grid-cols-2">
		...
		<Card>
			<h3 class="text-lg font-semibold text-white mb-4">
				<span class="inline-flex h-6 w-6 items-center justify-center rounded-full bg-red-500/20 text-xs font-bold text-red-400 mr-2">A</span>
				Current Loan
			</h3>
			<div class="space-y-4">
				<div>
					<label for="currentBalance" class="block text-sm font-medium text-surface-300">Remaining Balance</label>
					<input
						id="currentBalance"
						type="number"
				...
				<div>
					<label for="currentRate" class="block text-sm font-medium text-surface-300">Current Rate (%)</label>
					<input
						id="currentRate"
						type="number"
				...
				<div>
					<label for="currentMonthly" class="block text-sm font-medium text-surface-300">Monthly Payment</label>
					<input
						id="currentMonthly"
						type="number"
				...
				<div>
					<label for="currentRemaining" class="block text-sm font-medium text-surface-300">Remaining Months</label>
					<input
						id="currentRemaining"
						type="number"
		...
		<Card>
			<h3 class="text-lg font-semibold text-white mb-4">
				<span class="inline-flex h-6 w-6 items-center justify-center rounded-full bg-green-500/20 text-xs font-bold text-green-400 mr-2">B</span>
				New Loan (Refinance)
			</h3>
			<div class="space-y-4">
				<div>
					<label for="newRate" class="block text-sm font-medium text-surface-300">New Rate (%)</label>
					<input
						id="newRate"
						type="number"
						bind:value={newRate}
				...
				<div>
					<label for="newTerm" class="block text-sm font-medium text-surface-300">New Loan Term</label>
					<div class="mt-1 flex gap-2">
						{#each [10, 15, 20, 30] as term}
							<button
								class="flex-1 rounded-lg border px-3 py-2 text-sm font-medium transition {newTermYears === term
				...
				<div>
					<label for="closingCosts" class="block text-sm font-medium text-surface-300">Closing Costs</label>
					<input
						id="closingCosts"
						type="number"
	...
	<div class="grid gap-4 sm:grid-cols-2">
		...
		<Card>
			<div class="text-center py-4">
				...
				<p class="mt-2 text-3xl font-bold {totalSavingsOverLife > 0 ? 'text-green-400' : 'text-red-400'}">
