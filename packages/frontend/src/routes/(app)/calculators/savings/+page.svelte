<script lang="ts">
  ...
  let chartData = $derived.by(() => {
    ...
    if (bd.length === 0)
      return { contributionPoints: '', interestPoints: '', balancePoints: '', maxVal: 0 };
  ...
  <div class="grid gap-6 lg:grid-cols-5">
    ...
    <div class="lg:col-span-2 space-y-4">
      <Card>
        ...
        <div class="space-y-4">
          <div>
            <label for="initial" class="block text-sm font-medium text-surface-300"
          ...
          <div>
            <label for="monthly" class="block text-sm font-medium text-surface-300"
          ...
          <div>
            <label for="rate" class="block text-sm font-medium text-surface-300"
          ...
          <div>
            <label for="years" class="block text-sm font-medium text-surface-300"
          ...
          <div>
            <label for="frequency" class="block text-sm font-medium text-surface-300"
