...
export const actions: Actions = {
  addDebt: async ({ request, locals }) => {
    ...
    const data = {
      ...
      dueDay: formData.get('dueDay') ? parseInt(formData.get('dueDay') as string, 10) : undefined,
    };
