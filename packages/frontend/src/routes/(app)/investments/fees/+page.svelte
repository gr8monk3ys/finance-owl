      ...
      <div class="flex items-start gap-4">
        ...
        <div>
          ...
          <div class="mt-3 flex gap-4 text-xs text-surface-500">
            ...
            >
            <span
              >Annual cost: <span class="text-red-400">{fmt(data.summary.totalAnnualFees)}</span
              ></span
            >
            <span
        ...
        <table class="w-full text-sm">
          ...
          <tfoot>
            <tr class="border-t border-surface-600 bg-surface-700/30">
              <td class="px-6 py-3 font-semibold text-white" colspan="3"> Weighted Average </td>
              <td
                class="px-4 py-3 text-right font-semibold {erColor(data.fees.weightedExpenseRatio)}"
              >
        ...
        <div class="mt-4 rounded-lg border border-surface-700 bg-surface-800/50 p-4">
          <div class="flex items-start gap-3">
            ...
            <p class="text-sm text-surface-300">
              ...
              <strong class="text-green-400">{fmt(data.impact30.projectedWithLowCostFees)}</strong>
              instead of
              <strong class="text-red-400">{fmt(data.impact30.projectedWithCurrentFees)}</strong>
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="text-right">
              ...
              <p class="text-lg font-bold text-green-400">
                {fmt(totalPotentialSavings)}<span class="text-sm text-surface-500">/yr</span>
              </p>
            </div>
          </div>
        </div>
