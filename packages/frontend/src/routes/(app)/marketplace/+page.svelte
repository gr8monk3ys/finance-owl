...
<div class="space-y-6">
  ...
  <div>
    ...
    <p class="mt-1 text-sm text-surface-400">Discover financial products tailored to your needs.</p>
  </div>
                  ...
                  <a
                    ...
                    onclick={() => {
                      const formEl = document
                        .querySelector(`form input[value="${product.id}"]`)
                        ?.closest('form');
  ...
  {#if data.products.length === 0}
    <Card>
      <div class="flex flex-col items-center justify-center py-12 text-center">
        ...
        <p class="mt-1 text-sm text-surface-500">Try a different category or check back later.</p>
      </div>
    </Card>
  {:else}
    <div class="space-y-3">
