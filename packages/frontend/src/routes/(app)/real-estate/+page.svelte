...
<div class="space-y-6">
  ...
  <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <Card>
      ...
      <p
        class="mt-1 text-2xl font-bold {data.summary.totalEquity >= 0
          ? 'text-green-400'
          : 'text-red-400'}"
      >
          ...
          <div class="mt-4 space-y-2 border-t border-surface-700 pt-4">
            ...
            {#if property.purchasePrice}
              <div class="flex items-center justify-between">
                ...
                <span
                  class="font-semibold {getEquity(property) >= 0
                    ? 'text-green-400'
                    : 'text-red-400'}"
                >
...
<Modal open={showAddModal} onclose={() => (showAddModal = false)} title="Add Property">
  ...
  >
    ...
    <div>
      <label for="propertyType" class="block text-sm font-medium text-surface-300"
        >Property Type</label
      >
      <select
        id="propertyType"
