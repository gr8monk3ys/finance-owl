...
<svelte:head>
  <title>Receipts - Finance Owl</title>
</svelte:head>
      ...
      <div class="border-t border-surface-700 pt-4">
        <div class="flex flex-wrap gap-2">
          {#if !selectedReceipt.transactionId}
            <Button size="sm" variant="secondary" onclick={openCreateTx}>Create Transaction</Button>
            <Button size="sm" variant="secondary" onclick={openLinkTx}>Link to Transaction</Button>
          {:else}
