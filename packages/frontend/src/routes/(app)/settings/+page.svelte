...
<div class="mx-auto max-w-2xl space-y-6">
  ...
  <Card>
    <div class="flex items-center gap-4">
      <div
        class="flex h-14 w-14 items-center justify-center rounded-full bg-primary-600/20 text-xl font-bold text-primary-400"
      >
  ...
  <div class="grid gap-3 sm:grid-cols-2">
    {#each settingsLinks as link}
      ...
      >
        <div
          class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg {link.iconColor}"
        >
          {#if link.icon === 'shield'}
            <svg
              class="h-5 w-5"
