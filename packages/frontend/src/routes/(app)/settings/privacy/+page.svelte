<script lang="ts">
  ...
  const consentTypes = [
    ...
    },
    {
      ...
      description: 'Receive personalized offers, tips, and updates about new features via email.',
    },
    {
      key: 'analytics',
      label: 'Analytics & Improvements',
      description: 'Help us improve the app by sharing anonymized usage data and crash reports.',
    },
    {
      key: 'third_party',
  ...
  function isConsentGranted(consentType: string): boolean {
    const consent = data.dashboard.consents.find((c: any) => c.consentType === consentType);
  ...
  <div class="flex items-center gap-3">
    ...
    <div>
      ...
      <p class="text-sm text-surface-400">
        Manage your data, consent preferences, and privacy rights
      </p>
    </div>
  </div>
        ...
        {#each consentTypes as consent}
          ...
          >
            ...
            <div class="flex items-center justify-between">
              ...
              >
                <span
                  class="pointer-events-none inline-block h-5 w-5 translate-y-0.5 rounded-full bg-white shadow transition-transform {isConsentGranted(
                    consent.key,
                  )
                    ? 'translate-x-5'
                    : 'translate-x-0.5'}"
        ...
        <div class="rounded-lg border border-red-800/50 bg-red-900/20 p-4">
          ...
          >
            ...
            <div class="flex gap-3">
              ...
              <Button variant="secondary" onclick={() => (showDeletionConfirm = false)}>
                Cancel
              </Button>
            </div>
          </form>
    ...
    <div class="space-y-4 p-6">
      ...
      <div class="space-y-3 text-sm text-surface-400">
        <div class="flex items-start gap-3">
          ...
          <p>
            <strong class="text-surface-300">Right to Access:</strong> You can export all your personal
            data at any time using the export feature above.
          </p>
        </div>
        <div class="flex items-start gap-3">
          <svg
          ...
          <p>
            <strong class="text-surface-300">Right to Erasure:</strong> Request complete deletion of your
        ...
        <div class="flex items-start gap-3">
          ...
          <p>
            <strong class="text-surface-300">Right to Withdraw Consent:</strong> Toggle any consent preference
            off at any time without affecting prior processing.
          </p>
        </div>
        <div class="flex items-start gap-3">
          <svg
          ...
          <p>
            <strong class="text-surface-300">Data Portability:</strong> Your exported data is provided
            in standard JSON format for easy transfer.
          </p>
        </div>
      </div>
    </div>
