        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xs text-surface-500">
              {stats.allTimeCount} round-up{stats.allTimeCount !== 1 ? 's' : ''}
            </p>
          </div>
        </div>
      </Card>
      <Card>
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xs text-surface-500">
              {stats.thisMonthCount} round-up{stats.thisMonthCount !== 1 ? 's' : ''}
            </p>
          </div>
        </div>
      </Card>
      ...
      >
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-xs text-surface-500">Automatically track round-ups on your purchases</p>
          </div>
          <button
            type="button"
        ...
        <Button type="submit" class="w-full" loading={saving}>Save Configuration</Button>
      </form>
    </Card>
      ...
      <Card>
        ...
        <div class="space-y-3">
          <div class="flex items-start gap-3">
            <div
              class="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-primary-600/20 text-xs font-bold text-primary-400"
            >
              1
            </div>
            <div>
