...
<div class="space-y-6">
  ...
  <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <Card>
      ...
      <p
        class="mt-1 text-2xl font-bold {data.summary.totalDepreciation > 0
          ? 'text-red-400'
          : 'text-green-400'}"
      >
      ...
      {#each data.vehicles as vehicle}
        <Card>
          <div class="flex items-start justify-between">
            ...
            <span
              class="ml-2 inline-flex shrink-0 items-center rounded-full px-2.5 py-0.5 text-xs font-medium {conditionBadgeClass(
                vehicle.condition,
              )}"
            >
...
<Modal open={showAddModal} onclose={() => (showAddModal = false)} title="Add Vehicle">
  ...
  >
    ...
    <div class="grid grid-cols-2 gap-3">
      <div>
        <label for="purchasePrice" class="block text-sm font-medium text-surface-300"
      ...
      <div>
        <label for="purchaseDate" class="block text-sm font-medium text-surface-300"
          >Purchase Date</label
        >
        <input
          id="purchaseDate"
    ...
    <div>
      <label for="currentEstimate" class="block text-sm font-medium text-surface-300"
