  ...
  <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
    ...
    <div class="hidden items-center gap-8 md:flex">
      <button
        ...
        class="rounded-lg px-2 py-1 text-sm text-gray-400 transition hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400/70"
        >Features</button
      >
      <button
        type="button"
    ...
    <div class="hidden items-center gap-3 md:flex">
      <a
        href="/auth/login"
        class="rounded-lg px-4 py-2 text-sm font-medium text-gray-300 transition hover:text-white"
      >
        Sign In
      </a>
      <a
    ...
    <div id="mobile-nav" class="border-t border-white/5 bg-gray-950/95 backdrop-blur-xl md:hidden">
      <div class="space-y-1 px-4 pb-4 pt-2">
        <button
          ...
          class="block w-full rounded-lg px-3 py-2.5 text-left text-sm text-gray-300 hover:bg-white/5 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400/70"
          >Features</button
        >
        <button
          type="button"
        ...
        <div class="border-t border-white/5 pt-2">
          <a
            href="/auth/login"
            class="block rounded-lg px-3 py-2.5 text-sm text-gray-300 hover:bg-white/5 hover:text-white"
            >Sign In</a
          >
          <a
            href="/auth/register"
...
<main id="main-content">
  ...
  <section class="relative min-h-screen overflow-hidden bg-gray-950 pt-16">
    ...
    <div class="absolute inset-0">
      <div
        class="absolute left-1/2 top-0 h-[600px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-emerald-500/8 blur-[120px]"
      ></div>
      <div
        class="absolute bottom-0 left-0 h-[400px] w-[600px] -translate-x-1/3 rounded-full bg-emerald-600/5 blur-[100px]"
      ></div>
      <div
        class="absolute right-0 top-1/3 h-[300px] w-[400px] translate-x-1/4 rounded-full bg-blue-500/5 blur-[80px]"
      ></div>
      <!-- Grid pattern -->
      <div
    ...
    <div
      class="relative mx-auto flex max-w-7xl flex-col items-center px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32 lg:px-8 lg:pt-40"
    >
      <!-- Badge -->
      <div
        class="mb-8 inline-flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-4 py-1.5 text-sm text-emerald-400"
      >
      ...
      <!-- Headline -->
      <h1
        class="max-w-4xl text-5xl font-extrabold tracking-tight text-white sm:text-6xl lg:text-7xl"
      >
        Take Control of
        <span
          class="bg-gradient-to-r from-emerald-400 via-emerald-300 to-teal-400 bg-clip-text text-transparent"
        >
          Your Money
        </span>
      </h1>
      ...
      <p class="mt-6 max-w-2xl text-lg leading-relaxed text-gray-400 sm:text-xl">
        Track spending, stay on top of recurring bills, and build a plan that actually fits your
        life. Your personal finance command center.
      </p>
      ...
      <div class="relative mt-16 w-full max-w-4xl animate-on-scroll visible">
        <div
          class="absolute -inset-4 rounded-3xl bg-gradient-to-b from-emerald-500/20 via-emerald-500/5 to-transparent blur-xl"
        ></div>
        <div
          class="relative overflow-hidden rounded-2xl border border-white/10 bg-gray-900/80 shadow-2xl shadow-black/50"
        >
          <!-- Mock browser chrome -->
          <div class="flex items-center gap-2 border-b border-white/5 bg-gray-900 px-4 py-3">
            ...
            <div class="ml-4 flex-1 rounded-lg bg-gray-800/80 px-3 py-1 text-xs text-gray-500">
              app.financeowl.com/dashboard
            </div>
          </div>
          ...
          <div class="p-6">
            <div class="grid gap-4 sm:grid-cols-3">
              <!-- Net worth card -->
              <div
                class="rounded-xl border border-emerald-800/30 bg-gradient-to-br from-emerald-950/60 to-gray-800/50 p-4"
              >
              ...
              <div class="rounded-xl border border-white/5 bg-gray-800/50 p-4">
                ...
                <div class="mt-2 h-1.5 rounded-full bg-gray-700">
                  <div
                    class="h-full w-3/4 rounded-full bg-gradient-to-r from-emerald-500 to-emerald-400"
                  ></div>
                </div>
              </div>
            </div>
  ...
  <section id="features" class="relative bg-gray-950 py-24">
    <div class="absolute inset-0">
      <div
        class="absolute left-0 top-1/4 h-[400px] w-[500px] -translate-x-1/2 rounded-full bg-emerald-500/5 blur-[100px]"
      ></div>
    </div>
      ...
      <div class="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <p class="mt-2 text-sm leading-relaxed text-gray-400">
            Spot recurring charges, review subscription history, and understand what is quietly
            draining your budget each month.
          </p>
        </div>
        ...
        >
          ...
          <p class="mt-2 text-sm leading-relaxed text-gray-400">
            We help you lower your bills. Get guided scripts and tools to negotiate better rates on
            cable, internet, insurance, and more.
          </p>
        </div>
        ...
        >
          ...
          <p class="mt-2 text-sm leading-relaxed text-gray-400">
            Set up savings goals, round-up style rules, and progress tracking so it is easier to
        ...
        >
          ...
          <p class="mt-2 text-sm leading-relaxed text-gray-400">
            See all your investments in one place. Track performance, asset allocation, and fees
            across every brokerage account.
          </p>
        </div>
        ...
        >
          ...
          <p class="mt-2 text-sm leading-relaxed text-gray-400">
            Zero-based budgeting made simple. Assign every dollar a job with our intuitive envelope
            system and stay on track.
          </p>
        </div>
        ...
        >
          ...
          <p class="mt-2 text-sm leading-relaxed text-gray-400">
            See trends, category changes, and practical recommendations that help you make better
  ...
  <section id="how-it-works" class="relative bg-gray-950 py-24">
    <div class="absolute inset-0">
      <div
        class="absolute right-0 top-1/3 h-[400px] w-[500px] translate-x-1/2 rounded-full bg-emerald-500/5 blur-[100px]"
      ></div>
    </div>
      ...
      <div class="mt-16 grid gap-8 lg:grid-cols-3">
        ...
        <div class="animate-on-scroll relative">
          <div class="flex flex-col items-center text-center lg:items-start lg:text-left">
            <div
              class="flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-500/10 text-2xl font-bold text-emerald-400 ring-1 ring-emerald-500/20"
            >
              1
            </div>
            <!-- Connector line (desktop only) -->
            <div
              class="absolute left-[calc(50%+2rem)] top-7 hidden h-px w-[calc(100%-4rem)] bg-gradient-to-r from-emerald-500/30 to-transparent lg:block"
            ></div>
            <h3 class="mt-6 text-xl font-semibold text-white">Link Your Accounts</h3>
            <p class="mt-3 text-sm leading-relaxed text-gray-400">
              Connect bank accounts, credit cards, and investments when account-linking is enabled
              for your workspace, or begin with manual accounts immediately.
            </p>
          </div>
        </div>
        ...
        <div class="animate-on-scroll relative">
          <div class="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <p class="mt-3 text-sm leading-relaxed text-gray-400">
              Instantly see your net worth, spending patterns, subscriptions, and upcoming bills.
              Everything organized and easy to understand.
            </p>
          </div>
        </div>
        ...
        <div class="animate-on-scroll">
          <div class="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <p class="mt-3 text-sm leading-relaxed text-gray-400">
              Use savings goals, recurring reminders, and smart rules to stay consistent and keep
      ...
      <div class="mt-14 grid gap-6 lg:grid-cols-3">
        <div class="animate-on-scroll rounded-2xl border border-white/5 bg-gray-900/50 p-6">
          ...
          <h3 class="mt-3 text-xl font-semibold text-white">
            See balances, budgets, and transactions together.
          </h3>
          <p class="mt-3 text-sm leading-relaxed text-gray-300">
            Track the basics from one dashboard instead of bouncing between spreadsheets, banking
            apps, and manual notes.
          </p>
        </div>
        ...
        <div class="animate-on-scroll rounded-2xl border border-white/5 bg-gray-900/50 p-6">
          ...
          <h3 class="mt-3 text-xl font-semibold text-white">
            Search, review, and adjust without friction.
          </h3>
          <p class="mt-3 text-sm leading-relaxed text-gray-300">
            The core experience is designed for quick decision-making: recent activity, budget
            progress, and recurring spend all stay easy to scan.
          </p>
        </div>
        ...
        <div class="animate-on-scroll rounded-2xl border border-white/5 bg-gray-900/50 p-6">
          ...
          <h3 class="mt-3 text-xl font-semibold text-white">
            Use connected finance tools without giving up control.
          </h3>
          <p class="mt-3 text-sm leading-relaxed text-gray-300">
  ...
  <section id="pricing" class="relative bg-gray-950 py-24">
    <div class="absolute inset-0">
      <div
        class="absolute left-1/2 top-0 h-[400px] w-[600px] -translate-x-1/2 rounded-full bg-emerald-500/5 blur-[100px]"
      ></div>
    </div>
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-16 grid gap-6 lg:grid-cols-3">
        ...
        <!-- Pro tier -->
        <div
          class="animate-on-scroll relative rounded-2xl border border-emerald-500/30 bg-gradient-to-b from-emerald-950/50 to-gray-900/50 p-8 shadow-xl shadow-emerald-900/20"
        >
          <div class="absolute -top-3 left-1/2 -translate-x-1/2">
            <span
              class="rounded-full bg-emerald-500 px-4 py-1 text-xs font-semibold text-white shadow-lg shadow-emerald-900/40"
            >
              Most Popular
            </span>
          </div>
  ...
  <section class="relative bg-gray-950 py-24">
    <div class="absolute inset-0">
      <div
        class="absolute left-1/2 top-1/2 h-[600px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-emerald-500/8 blur-[120px]"
      ></div>
    </div>

    <div class="relative mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
      <div class="animate-on-scroll">
        <h2 class="text-3xl font-bold text-white sm:text-4xl">Ready to Take Control?</h2>
        <p class="mt-4 text-lg text-gray-400">
          Start with the core workflows that already matter most: understanding where money is
          going, what needs attention, and what to change next.
        </p>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul class="mt-4 space-y-2.5">
            <li>
              <button
                onclick={() => scrollTo('features')}
                class="text-sm text-gray-300 transition hover:text-white">Features</button
              >
            </li>
            <li>
              <button
                onclick={() => scrollTo('pricing')}
                class="text-sm text-gray-300 transition hover:text-white">Pricing</button
              >
            </li>
            <li>
              <a href="/auth/register" class="text-sm text-gray-300 transition hover:text-white"
                >Get Started</a
              >
            </li>
          </ul>
        ...
        <div>
          ...
          <ul class="mt-4 space-y-2.5">
            <li>
              <a href="/security" class="text-sm text-gray-300 transition hover:text-white"
                >Security</a
              >
            </li>
            <li>
              <a
                href="https://github.com/gr8monk3ys/finance-owl"
                class="text-sm text-gray-300 transition hover:text-white">GitHub</a
              >
            </li>
            <li>
              <a
                href={publicRoutes.support}
                class="text-sm text-gray-300 transition hover:text-white">Support</a
              >
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="mt-4 space-y-2.5">
            <li>
              <a href="/privacy" class="text-sm text-gray-300 transition hover:text-white"
                >Privacy Policy</a
              >
            </li>
            <li>
              <a href="/terms" class="text-sm text-gray-300 transition hover:text-white"
                >Terms of Service</a
              >
            </li>
            <li>
