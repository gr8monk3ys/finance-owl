...
<div class="relative flex min-h-screen items-center justify-center bg-surface-900 px-4">
  ...
  <div class="absolute inset-0 overflow-hidden">
    ...
    ></div>
    <div
      class="absolute bottom-0 right-0 h-[300px] w-[400px] translate-x-1/4 rounded-full bg-blue-500/5 blur-[80px]"
    ></div>
  </div>
  ...
  <div class="relative w-full max-w-md space-y-8">
    ...
    >
      ...
      <div class="space-y-3">
        ...
        >
          ...
          <span
            class="rounded-full border border-surface-600 px-2 py-0.5 text-[10px] uppercase tracking-wide text-surface-300"
            >Soon</span
          >
        </button>
        <button
      ...
      >
        ...
        <div>
          <div class="flex items-center justify-between">
            ...
            <a
              ...
              class="text-xs text-primary-400 transition hover:text-primary-300">Forgot password?</a
            >
          </div>
          <input
            id="password"
        ...
        {#if showTotp}
          <div>
            <label for="totpCode" class="block text-sm font-medium text-surface-300"
    ...
    <p class="text-center text-sm text-surface-300">
      ...
      <a
        href="/auth/register"
        class="font-medium text-primary-400 transition hover:text-primary-300">Create one free</a
      >
    </p>
  </div>
</div>
