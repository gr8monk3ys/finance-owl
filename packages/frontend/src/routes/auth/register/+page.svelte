...
<div class="relative flex min-h-screen items-center justify-center bg-surface-900 px-4 py-8">
  ...
  <div class="absolute inset-0 overflow-hidden">
    <div
      class="absolute left-1/2 top-0 h-[500px] w-[700px] -translate-x-1/2 -translate-y-1/3 rounded-full bg-primary-500/5 blur-[100px]"
    ></div>
    <div
      class="absolute bottom-0 left-0 h-[300px] w-[400px] -translate-x-1/4 rounded-full bg-blue-500/5 blur-[80px]"
    ></div>
  </div>
  ...
  <div class="relative w-full max-w-md space-y-8">
    ...
    <div
      class="rounded-2xl border border-surface-700/50 bg-surface-800/80 p-8 shadow-xl backdrop-blur-sm"
    >
      ...
      <div class="space-y-3">
        ...
        >
          ...
          <span
            class="rounded-full border border-surface-600 px-2 py-0.5 text-[10px] uppercase tracking-wide text-surface-500"
            >Soon</span
          >
        </button>
        <button
      ...
      >
        ...
        <div>
          ...
          {#if password}
            <div class="mt-2">
              ...
              <p
                class="mt-1 text-xs {passwordStrength.score <= 1
                  ? 'text-red-400'
        ...
        <p class="text-center text-xs leading-relaxed text-surface-500">
          ...
          <a
            href="/terms"
            class="text-surface-400 underline decoration-surface-600 underline-offset-2 transition hover:text-white"
            >Terms of Service</a
          >
          and
          <a
    ...
    <p class="text-center text-sm text-surface-400">
      ...
      <a href="/auth/login" class="font-medium text-primary-400 transition hover:text-primary-300"
        >Sign in</a
      >
    </p>
  </div>
