<script lang="ts">
  ...
  let manualAccounts = $state<ManualAccount[]>([{ name: '', type: 'checking', balance: '' }]);
  ...
  let goals = $state<Goal[]>([
    ...
    },
    {
      ...
      description: 'Automate savings and build an emergency fund',
      checked: false,
    },
    {
      id: 'debt',
    ...
    },
    {
      ...
      description: 'Track and grow your portfolio',
      checked: false,
    },
    {
      id: 'budget',
      label: 'Stay on budget',
      description: 'Zero-based budgeting with envelopes',
      checked: false,
    },
  ]);
    ...
    <div class="w-full max-w-2xl">
      ...
      {#if currentStep === 1}
        <div class="step-content">
          ...
          {#if bankLinked}
            <div
              class="mt-8 rounded-xl border border-primary-500/30 bg-primary-950/30 p-6 text-center"
            >
              <div
      ...
      {#if currentStep === 3}
        <div class="step-content">
          ...
          <!-- Total -->
          <div
            class="mt-6 rounded-xl border border-primary-800/30 bg-primary-950/20 p-4 text-center"
          >
          ...
          <div class="mt-8 grid gap-3 sm:grid-cols-3">
            ...
            <div class="rounded-xl border border-surface-700/50 bg-surface-800/50 p-4">
              <p class="text-2xl font-bold text-blue-400">
                {goals.filter((g) => g.checked).length}
              </p>
