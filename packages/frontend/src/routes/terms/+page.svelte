...
<svelte:head>
  ...
  <meta
    name="description"
    content="Terms of Service for using the Finance Owl personal finance management platform."
  />
</svelte:head>
        ...
        <div class="max-w-3xl space-y-12">
          ...
          <section id="acceptance">
            ...
            <p class="mt-3 text-sm leading-relaxed text-surface-300">
              ...
              ("Company," "we," "us," or "our"). You must be at least 18 years old to use the Service.
          ...
          <section id="description">
            ...
            <p class="mt-3 text-sm leading-relaxed text-surface-300">
              Feature availability may vary by plan, platform, region, and connected provider.
              External account connections rely on the providers configured for the workspace at the
              time of use.
            </p>
          </section>
          ...
          <section id="accounts">
            ...
            <div class="mt-4 space-y-4">
              ...
              <div class="rounded-xl border border-surface-700/50 bg-surface-800 p-5">
                ...
                <p class="mt-2 text-sm leading-relaxed text-surface-300">
                  You are responsible for safeguarding your password and any other credentials used
                  to access the Service. You must notify us immediately at <a
              ...
              <div class="rounded-xl border border-surface-700/50 bg-surface-800 p-5">
                ...
                <p class="mt-2 text-sm leading-relaxed text-surface-300">
                  ...
                  Premium household sharing provides separate linked access for invited members with
                  shared budgets and views.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="billing">
            ...
            <div class="mt-4 space-y-4">
              <div class="rounded-xl border border-surface-700/50 bg-surface-800 p-5">
                ...
                <p class="mt-2 text-sm leading-relaxed text-surface-300">
                  The free plan provides limited access to the Service at no cost. We reserve the
                  right to modify the features available on the free plan at any time.
                </p>
              </div>
              <div class="rounded-xl border border-surface-700/50 bg-surface-800 p-5">
                <h3 class="text-base font-medium text-white">Paid Subscriptions</h3>
                <p class="mt-2 text-sm leading-relaxed text-surface-300">
                  Pro and Premium plans are billed on a recurring monthly or annual basis. By
                  subscribing, you authorize us to charge your payment method on file at the
                  beginning of each billing cycle. All fees are quoted in USD.
                </p>
              </div>
              <div class="rounded-xl border border-surface-700/50 bg-surface-800 p-5">
                <h3 class="text-base font-medium text-white">Cancellation and Refunds</h3>
                <p class="mt-2 text-sm leading-relaxed text-surface-300">
                  You may cancel your subscription at any time through Settings &gt; Billing. Upon
                  cancellation, you will retain access to paid features until the end of your
                  current billing period. We do not provide prorated refunds for partial billing
                  periods. Trial periods, if offered, are subject to their own terms.
                </p>
              </div>
              <div class="rounded-xl border border-surface-700/50 bg-surface-800 p-5">
                <h3 class="text-base font-medium text-white">Price Changes</h3>
                <p class="mt-2 text-sm leading-relaxed text-surface-300">
                  We may adjust pricing with at least 30 days' notice. Continued use of the Service
                  after a price change constitutes acceptance of the new pricing. Existing
                  subscribers will be notified via email before any price increase takes effect.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="intellectual-property">
            ...
            <p class="mt-3 text-sm leading-relaxed text-surface-300">
              The Service, including its original content, features, functionality, branding, and
              design, is and remains the exclusive property of {publicSite.legalEntityName} and its licensors.
              The Service is protected by copyright, trademark, and other laws of the United States and
              foreign countries.
            </p>
            <p class="mt-3 text-sm leading-relaxed text-surface-300">
              Our trademarks and trade dress may not be used in connection with any product or
              service without the prior written consent of {publicSite.legalEntityName}.
            </p>
          </section>
          ...
          <section id="user-content">
            ...
            <p class="mt-3 text-sm leading-relaxed text-surface-300">
              You represent and warrant that you have the right to submit any User Content and that
          ...
          <section id="liability">
            ...
            <div class="mt-4 rounded-xl border border-accent-500/20 bg-accent-950/20 p-5">
              <p class="text-sm leading-relaxed text-surface-300">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, {publicSite.legalEntityName.toUpperCase()} AND
              ...
              <ul class="mt-3 space-y-2">
                ...
                <li class="text-sm text-surface-300">
                  (c) Any financial decisions made based on information from the Service;
                </li>
                <li class="text-sm text-surface-300">
              ...
              <p class="mt-3 text-sm leading-relaxed text-surface-300">
                Our total liability shall not exceed the amount you have paid us in the twelve (12)
            ...
            <div class="mt-4 rounded-xl border border-accent-500/30 bg-surface-800 p-5">
              <div class="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="mt-2 text-sm leading-relaxed text-surface-300">
                    THE SERVICE IS PROVIDED FOR INFORMATIONAL AND EDUCATIONAL PURPOSES ONLY. FINANCE
                    OWL DOES NOT PROVIDE FINANCIAL, INVESTMENT, TAX, OR LEGAL ADVICE. The insights,
                    recommendations, and information provided through the Service should not be
                    relied upon as a substitute for professional financial advice.
                  </p>
                  <p class="mt-2 text-sm leading-relaxed text-surface-300">
                    Always consult with qualified financial professionals before making financial
                    decisions. We are not registered as investment advisors, broker-dealers, or
                    financial planners. Past performance data shown in the Service does not
          ...
          <section id="termination">
            ...
            <p class="mt-3 text-sm leading-relaxed text-surface-300">
              You may terminate your account at any time by going to Settings &gt; Privacy &gt;
              Delete Account, or by contacting us at <a
                href={publicMailto.support}
                class="text-primary-400 underline hover:text-primary-300"
                >{publicSite.supportEmail}</a
              >.
            </p>
          </section>
          ...
          <section id="governing-law">
            ...
            <p class="mt-3 text-sm leading-relaxed text-surface-300">
              For any disputes that cannot be resolved informally, you agree to first attempt
              resolution through binding arbitration administered by the American Arbitration
              Association under its Commercial Arbitration Rules, before resorting to court
              litigation.
            </p>
          </section>
          ...
          <section id="changes">
            ...
            <p class="mt-3 text-sm leading-relaxed text-surface-300">
              ...
              we will provide at least 30 days' notice via email and/or a prominent notice within
              the Service. Your continued use of the Service after the revised Terms take effect
